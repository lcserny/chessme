...
console.log(p2.name + " captured " + p2CapturedPiece.constructor.name + " " + p2CapturedPiece.playerColor);
...
console.log(p1.name + " captured " + p1CapturedPiece.constructor.name + " " + p1CapturedPiece.playerColor);